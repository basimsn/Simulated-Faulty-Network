...
LOGGER = homework.logging.get_logger("hw-tcp-tester")
if ARGS.verbose:
...
INPUT_LEN, INPUT_HASH = homework.utils.file_summary(INPUT_PATH)
...
RECV_LEN, RECV_HASH = homework.utils.file_summary(RECV_PATH)
